    ...
    <section id="skills" className="mx-auto max-w-6xl px-4 py-12 md:py-16">
      ...
      <div className="mt-6 grid gap-4 md:mt-8 md:grid-cols-2 xl:grid-cols-3">
        {groupsWithSkills.map((group) => (
          <div key={group} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition-all duration-300 hover:border-emerald-400/50 hover:shadow-[0_0_35px_rgba(16,185,129,0.35)] hover:scale-[1.02] dark:border-slate-800 dark:bg-slate-900 md:rounded-3xl md:p-6 active:scale-[0.98]">
